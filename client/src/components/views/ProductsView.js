...
const Products = () => {
  ...
  return (
    <>
      <div className="ant-card" style={{ height: 'calc(100vh - 120px)', display: selectedId ? "none" : "flex" , flexDirection: "column", gap: 10 }}>
        <div style={{ display: "flex", gap: 10, padding: 10 }}>
          <div style={{ flex: 1 }}/>
          <Button type="primary" style={{ borderRadius: 10 }} onClick={handleAddRecord}>
